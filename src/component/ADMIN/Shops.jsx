...
import {ADD_projector_item,Get_projector_item} from "../../redux/projector/projector.action";
import {ADD_solarpanel_item,Get_solarpanel_item} from "../../redux/solarpanel/solarpanel.action"
  ...
  return (
    <div>
      <Box w="84%" ml="16%" mt="50px" h="auto" p={10} bgColor="#f7f7f7 ">
            ...
            <Text color={"red"}>The data is directly being fetched by the database. Perform cautiously.</Text>
             <Button onClick={onOpen} bgColor="#19a598" color="white" _hover={{backgroundColor:"#2e3192"}}>+ Add PRODUCT</Button>
              </Flex>
            </Box>
            ...
            <ModalBody>
              ...
              <Select placeholder='Select Dealer Name' onChange={(e)=>SetDealer(e.target.value)}>
              ...
              <Input placeholder='Add Id' type="string" value={id} onChange={(e)=>Setid(e.target.value)}/>
              <Input placeholder='Add Name' type="string" value={name} onChange={(e)=>SetName(e.target.value)}/>
              <Input placeholder='Add Image' type="string" value={image} onChange={(e)=>SetImage(e.target.value)}/>
              <Input placeholder='Add Price' type="string" value={price} onChange={(e)=>SetPrice(e.target.value)}/>
              <Input placeholder='Add Company' type="string" value={company} onChange={(e)=>SetCompany(e.target.value)}/>
              </VStack>
            </ModalBody>

          <ModalFooter>
            <Button bgColor="#19a598" color="white" _hover={{backgroundColor:"#2e3192"}} mr={3} onClick={handlePost}>
              Add PRODUCT
            </Button>
            ...
            <Box mt="20px">
          <Menu>
          <MenuButton as={Button} bgColor="#19a598" color="white" _hover={{backgroundColor:"#2e3192"}} rightIcon={<ChevronDownIcon />}>FILTER</MenuButton>
          <MenuList>
