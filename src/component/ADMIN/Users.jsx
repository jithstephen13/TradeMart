...
import { Box, Flex, Grid, Text,Card,CardBody, CardFooter,Button } from '@chakra-ui/react'
            ...
            <Grid templateColumns={{sm:"repeat(1,1fr)",md:"repeat(2,1fr)",lg:"repeat(3,1fr)"}} gap={5}>
              {userlist.map((el)=>(
                ...
                <CardBody >
                  ...
                  <Text>{el.firstname} {el.laststname}</Text>
                  </Flex>
                ...
                <CardFooter>
                <Button onClick={()=>handleDelete(el.id)}  bgColor="#19a598" color="white" _hover={{backgroundColor:"#2e3192"}}>Delete User</Button>
                </CardFooter>
              </Card>
              ))}
            </Grid>
