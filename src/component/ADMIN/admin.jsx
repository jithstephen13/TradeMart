    ...
    <div>
      ...
      <div className={Styles.Sidebar}>
        <Box mt={6}  h="700px" bgColor="white">
            ...
            <Button bgColor="white" fontFamily="Cambria" w="100%" size={"md"} _hover={{bgColor:"#2e3192",color:"white"}} onClick={handleDashboard} leftIcon={<BsSpeedometer2/>}>Dashboard</Button>
            {/* <hr/>
           ...
           <Button bgColor="white" fontFamily="Cambria" w="100%" size={"md"} _hover={{bgColor:"#2e3192",color:"white"}} onClick={handleLocation} leftIcon={<ImLocation/>}>Location</Button>

           <Button bgColor="white" fontFamily="Cambria" w="100%" size={"md"} _hover={{bgColor:"#2e3192",color:"white"}} onClick={handleCustomers} leftIcon={<BsFillPeopleFill/>}>Customers</Button>

           <Button bgColor="white" fontFamily="Cambria" w="100%" size={"md"} _hover={{bgColor:"#2e3192",color:"white"}} onClick={handleUsers} leftIcon={<FaUserShield/>}>Users List</Button>

           <Button bgColor="white" fontFamily="Cambria" w="100%" size={"md"} _hover={{bgColor:"#2e3192",color:"white"}} onClick={handleAdmin} leftIcon={<MdAdminPanelSettings/>}>Admin List</Button>
            </VStack>
        </Box>
    </div>
