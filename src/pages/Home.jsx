...
import { Box, Button, Flex, Heading, Image, Input, Select, SimpleGrid, Text } from '@chakra-ui/react';
...
const Home = () => {
    ...
    let sec1=[
        {img:"https://3.imimg.com/data3/RS/UH/GLADMIN-5385/brick-making-machines-125x125.jpg",title:"Brick Making Machines",d1:"Fly Ash Brick Making Machine",d2:"Cement Brick Making Machine",d3:"Clay Brick Making Machine"},
        {img:"https://3.imimg.com/data3/OI/XL/GLADMIN-34562/passenger-lifts-125x125.jpg",title:"Passenger Lifts",d1:"Residential Elevator",d2:"Kone Passenger lift",d3:"Stair Lift"},
        {img:"https://3.imimg.com/data3/KS/JQ/GLADMIN-2475/tmt-bars-125x125.jpg",title:"TMT Bars",d1:"TATA TMT Bars",d2:"Kamdhenu TMT Bars",d3:""},
        {img:"https://5.imimg.com/data5/QO/YD/GLADMIN-2/plywoods-125x125.jpg",title:"Plywoods",d1:"Shuttering Plywood",d2:"Laminated Plywood",d3:"Waterproof Plywood"},
        {img:"https://3.imimg.com/data3/JE/DA/MY-2/hydraulic-excavator-500x500-125x125.jpg",title:"Excavator",d1:"Hitachi Excavator",d2:"Hyundai Excavator",d3:"Komatsu Excavator"},
        {img:"https://3.imimg.com/data3/VG/QG/GLADMIN-27799/emulsion-paints-125x125.jpg",title:"Emulsion Paints",d1:"Asian Emulsion Paints",d2:"Berger Emulsion Paints",d3:"Nerolac Emulsion Paints"},
    ]
    let hide1=[
        {img:"https://3.imimg.com/data3/UT/PB/GLADMIN-12558/wood-door-125x125.jpg",title:"Wooden Door",d1:"Designer Wooden Door",d2:"Plywood Door",d3:"Wooden Flush Doors"},
        {img:"https://3.imimg.com/data3/VN/LA/GLADMIN-2047/pvc-pipes-125x125.jpg",title:"PVC Pipes",d1:"Finolex Pipes",d2:"Rigid PVC Pipes",d3:"Flexible PVC Pipes"},
        {img:"https://3.imimg.com/data3/YD/WE/GLADMIN-23639/building-brick-125x125.jpg",title:"Building Brick",d1:"Red Brick",d2:"Fly Ash Bricks",d3:"Cement Brick"}
    ]
    let sec2=[
        {img:"https://4.imimg.com/data4/HI/RA/GLADMIN-181283/photocopier-machine-125x125.jpg",title:"Office Automation Products",d1:"Multifunction Printer",d2:"Xerox Machines",d3:"Fingerprint Scanners"},
        {img:"https://5.imimg.com/data5/GLADMIN/Default/2022/3/MZ/VG/IH/87924/arduino-sensor-125x125.jpg",title:"Sensors & Transducers",d1:"Level Sensors",d2:"Proximity Sensor",d3:"Sensor for Home & Office Load Cell"},
        {img:"https://5.imimg.com/data5/JW/EX/GLADMIN-2/digital-controller-125x125.jpg",title:"Process Controllers",d1:"Process Controllers",d2:"Level Controllers",d3:"Motor & Temperature Controllers"},
        {img:"https://5.imimg.com/data5/RO/JS/GLADMIN-2/lighting-controllers1-125x125.jpg",title:"Control & Automation",d1:"VFD",d2:"PLC",d3:"HMI"},
        {img:"https://3.imimg.com/data3/XB/KH/GLADMIN-105874/light-emitting-diode-125x125.jpg",title:"Diodes & Active Devices",d1:"Integrated Circuits",d2:"Thyristors",d3:"Light Emitting Diode"},
        {img:"https://5.imimg.com/data5/GLADMIN/Default/2022/6/SI/KH/VT/87924/house-wire-125x125.jpg",title:"Wires & Cables",d1:"House Wire",d2:"Armoured Cable",d3:"Power Cable"},
    ]
    let hide2=[
        {img:"https://5.imimg.com/data5/VB/IL/GLADMIN-2/street-light-125x125.jpg",title:"Commercial Lights",d1:"Flood Lights",d2:"Street Lights",d3:"Panel Light"},
        {img:"https://5.imimg.com/data5/LX/YW/GLADMIN-2/inverter-batteries-125x125.png",title:"Battries",d1:"Lithium Battery",d2:"Inverter Batteries",d3:"Electric Vehicle Battery"},
        {img:"https://3.imimg.com/data3/EX/HO/GLADMIN-37340/solar-power-systems-125x125.jpg",title:"Solar & Renewable Energy",d1:"Solar Panels",d2:"Solar Inverter",d3:"Solar Pumps"}
    ]
    let sec3=[
        {img:"https://5.imimg.com/data5/KT/MJ/MY-16675294/pharmaceutical-drug-125x125.jpg",title:"Pharmaceutical Drug",d1:"Anticoagulant and Antiplatelet Drugs",d2:"Antiparasitic Drug",d3:"Antibiotic Tablets, Capsule & Syrup",d4:"Antifungal Injection, Tablet & Syrup"},
        {img:"https://3.imimg.com/data3/JR/DH/GLADMIN-7427/nutritional-supplements-125x125.jpg",title:"Nutraceuticals",d1:"Vitamin Tablets & Capsules",d2:"Weight Loss Supplement",d3:"Dietary Supplements",d4:"Mineral Supplement"},
        {img:"https://5.imimg.com/data5/PQ/HW/MY-7191707/thinq-mass-gainer-282-lbs-29-125x125.png",title:"Fitness Supplements",d1:"Weight Gain Nutrition",d2:"Weight Gain Capsule",d3:"Pre workout Supplements",d4:"Immune Booster"},
        {img:"https://3.imimg.com/data3/BA/YT/MY-2018319/multidisciplinary-care-125x125.jpg",title:"Medical Treatment Services",d1:"Dental Treatment Services",d2:"Medical Surgery Services",d3:"Eye Treatment",d4:"Plastic Surgery Services"},
        {img:"https://5.imimg.com/data5/JM/MB/MY-4222986/8-125x125.jpg",title:"Medical Test Services",d1:"CT Scan Services",d2:"Ultrasound Services",d3:"ECHO Cardiography",d4:"Blood Testing"},
        {img:"https://5.imimg.com/data5/YC/QB/MY-3773531/allopathic-pcd-pharma-franchise-125x125.jpg",title:"PCD Pharma Franchise",d1:"Pharma Franchise",d2:"Allopathic",d3:"Ayurvedic",d4:"Veterinary"}
    ]
    let sec4=[
        {img:"https://3.imimg.com/data3/WE/MN/MY-2/food-processing-machine-125x125.jpg",title:"Food Processing Machine",d1:"Flour Mill",d2:"Spice Processing Machines",d3:"Rice Mill Machinery"},
        {img:"https://3.imimg.com/data3/SF/NU/MY-2/high-speed-automatic-t-shirt-bag-making-machine-two-line--125x125.jpg",title:"Bag Making Machine",d1:"Non Woven Bag Making Machine",d2:"Proximity Sensor",d3:"Sensor for Home & Office Load Cell"},
        {img:"https://5.imimg.com/data5/NG/VV/GLADMIN-2/nop300-125x125.png",title:"Snack Machine",d1:"Namkeen Making Machines",d2:"Popcorn Machines",d3:"Motor & Temperature Controllers"},
        {img:"https://3.imimg.com/data3/UK/HT/MY-2/deck-125x125.jpg",title:"Bakery & Dairy Machinery",d1:"Bakery Machinery",d2:"Bakery Oven",d3:"Sweets Making Machine"},
        {img:"https://5.imimg.com/data5/GLADMIN/Default/2022/6/MW/VE/VZ/87939/cnc-lathe-machine-125x125.png",title:"CNC Machines & Lathe Machine",d1:"Integrated Circuits",d2:"Thyristors",d3:"Light Emitting Diode"},
        {img:"https://3.imimg.com/data3/TU/LV/GLADMIN-2070/flexographic-printing-machine-125x125.jpg",title:"Printing Machine",d1:"House Wire",d2:"Armoured Cable",d3:"Power Cable"},
    ]
    let hide4=[
        {img:"https://3.imimg.com/data3/GF/WP/GLADMIN-45894/industrial-compressor-125x125.jpg",title:"Air Compressors",d1:"Flood Lights",d2:"Street Lights",d3:"Panel Light"},
        {img:"https://5.imimg.com/data5/PA/NP/GLADMIN-2/seawaterfiltrationsystem-125x125.jpg",title:"Water Purification Plants",d1:"Lithium Battery",d2:"Inverter Batteries",d3:"Electric Vehicle Battery"},
...
{/* ------------------------------Construction------------------------------------ */}
            <Box borderTop="3px solid purple" backgroundColor="white" marginTop="20px" w="96%">
                <Heading align="left" p="5px 10px" fontSize={{base:"18px",sm:"22px", md:"28px"}} fontFamily ="Arial" color="#333" >Building Construction Material & Equipment</Heading>
...
{/* ------------------------------Electronics------------------------------- */}
            <Box borderTop="3px solid purple" backgroundColor="white" marginTop="20px" w="96%">
                <Heading align="left" p="5px 10px" fontSize={{base:"18px",sm:"22px", md:"28px"}} fontFamily ="Arial" color="#333" >Electronics & Electrical Goods & Supplies</Heading>
                <Flex height="100%" w="95%" m="auto" p="10px 0px" >
                    <Box w={{base:"0%",xl:"28%"}} visibility={{base:"hidden",xl:"visible"}} >
...
{/* -------------------------------Medicine------------------------------------- */}
            <Box borderTop="3px solid purple" backgroundColor="white" marginTop="20px" w="96%">
                <Heading align="left" p="5px 10px 0px 10px" fontSize={{base:"18px",sm:"22px", md:"28px"}} fontFamily ="Arial" color="#333" >Pharmaceutical Drug, Medicine, Medical Care & Consultation</Heading>
...
{/* -------------------------------Software---------------------------------- */}
            <Flex borderTop="3px solid purple" backgroundColor="white" marginTop="20px" w="96%" >
...
{/* -------------------------------Mobile App--------------------------------- */}
            <Flex borderTop="3px solid purple" backgroundColor="white" justifyContent="space-evenly" margin="20px" w="96%" >
                <Box p={{base:"10px",md:"50px 0px 0px 0px"}} >
                    <Image w="70%" src={app1} />
                </Box>
