...
import { AddAdminApi, AddUserApi, DeleteUserAPI, GetAllAdminAPI, GetAllUseresAPI, LoginApi, LogoutApi } from "./auth.api";

 
export const AddUser=( cred={})=>async(dispatch)=>{
...
export const AddAdmin=( cred={})=>async(dispatch)=>{
