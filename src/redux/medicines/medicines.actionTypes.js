export const GET_medicines_LOADING = "medicines/get/laoding";
export const GET_medicines_SUCCESS = "medicines/get/success";
export const GET_medicines_ERROR = "medicines/get/error";

// add item  
export const ADD_medicines_LOADING = "medicines/add/laoding";
export const ADD_medicinesT_SUCCESS = "medicines/add/success";
export const ADD_medicines_ERROR = "medicines/add/error";
